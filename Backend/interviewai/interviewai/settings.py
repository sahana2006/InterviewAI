"""
Django settings for interviewai project.
...
SECRET_KEY = 'django-insecure-uhgw_vv)p%5-e%!a@p=&k_#suk=sdt8i26^26@$s-@1e@b94ml'
...
APPEND_SLASH = True
import os
MEDIA_URL = '/media/'  # Public-facing URL prefix
